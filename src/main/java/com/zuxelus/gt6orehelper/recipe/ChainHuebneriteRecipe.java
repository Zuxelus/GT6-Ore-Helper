...
public class ChainHuebneriteRecipe extends ChainRecipe {

	public ChainHuebneriteRecipe(IInventory inventory) {
		super(inventory, "Huebnerite -> Tungsten", CHAIN6);
		groups = new SlotGroup[6];
		groups[0] = new SlotGroup(inventory, 0, 9, 25, new ItemStack[] {
				OP.dust.mat(MT.OREMATS.Huebnerite, 6), null, getStack(MT.HCl.mGas.getFluid(), 4000), null, 
				OP.dust.mat(MT.MnCl2, 3), OP.dust.mat(MT.H2WO4, 7), null, null,
		...
		groups[3] = new SlotGroup(inventory, 30, 121, 133, new ItemStack[] {
				...
				null, null, getStack(MT.MnCl2.mLiquid.getFluid(), 432), null,
