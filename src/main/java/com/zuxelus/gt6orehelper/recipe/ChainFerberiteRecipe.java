...
public class ChainFerberiteRecipe extends ChainRecipe {

	public ChainFerberiteRecipe(IInventory inventory) {
		super(inventory, "Ferberite -> Tungsten", CHAIN6);
		groups = new SlotGroup[6];
		groups[0] = new SlotGroup(inventory, 0, 9, 25, new ItemStack[] {
				OP.dust.mat(MT.OREMATS.Ferberite, 6), null, getStack(MT.HCl.mGas.getFluid(), 4000), null, 
				OP.dust.mat(MT.FeCl2, 3), OP.dust.mat(MT.H2WO4, 7), null, null,
		...
		groups[3] = new SlotGroup(inventory, 30, 121, 133, new ItemStack[] {
				OP.dust.mat(MT.FeCl2, 3), null, null, null,
				null, null, getStack(MT.FeCl2.mLiquid.getFluid(), 432), null,
				getMachineStack("Smelter") });
		groups[4] = new SlotGroup(inventory, 40, 9, 133, new ItemStack[] {
				 null, null, getStack(MT.FeCl2.mLiquid.getFluid(), 432), null,
				OP.dust.mat(MT.Fe, 1), null,getStack(MT.Cl.mGas.getFluid(), 2000), null,
